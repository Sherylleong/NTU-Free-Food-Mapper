  ...
  <nav className ="flex items-center justify-between flex-wrap bg-gray-800 p-4">
    ...
    <div className="flex items-center space-x-4">
      <div className ="block lg:hidden ">
        ...
        <div>
          <a href="https://github.com/Sherylleong/NTUFreeFood-StatTracker" target="_blank" className ="flex items-center text-sm px-3 py-2 leading-none border rounded text-teal-200 border-teal-400 hover:text-white hover:border-white ">View Code on Github</a>
        </div>
